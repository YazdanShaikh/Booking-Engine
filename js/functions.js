...
function sliderTopDestinationsSmall() {
	$(".slider-top-destinations-small").each(function () {
		var sliderTopDestinations = $(this).find(".slick-slider-small");
		sliderTopDestinations.slick({
			slidesToShow: 6,
			slidesToScroll: 1,
			dots: false,
